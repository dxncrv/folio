...
<div class="project">
	<a data-sveltekit-preload-data href={'projects/' + slugify(project.title)}>
		<img src={project.image} alt={project.title} />
		<h2>
			<iconify-icon class="case-study" icon="line-md:folder-multiple-twotone" height="24" width="24"
			></iconify-icon>
