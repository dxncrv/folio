...
<style>
    .toastylink{display:flex;flex-direction:row;gap:0.5rem;position:absolute;top:-0.9rem;right:1rem;color:rgb(15,166,236);font-family:var(--font-ui);text-decoration:none; background:var(--bg);padding:0.25rem 0.75rem;border-radius:12px;}.toastylink:hover{background:var(--bg);border-color:var(--accent);color:var(--accent)}
